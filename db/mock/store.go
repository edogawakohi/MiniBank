...
// Source: minibank/db/sqlc (interfaces: Store)
...
// GetEntryAnAccount mocks base method.
func (m *MockStore) GetEntryAnAccount(arg0 context.Context, arg1 int64) (db.GetEntryAnAccountRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEntryAnAccount", arg0, arg1)
	ret0, _ := ret[0].(db.GetEntryAnAccountRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEntryAnAccount indicates an expected call of GetEntryAnAccount.
func (mr *MockStoreMockRecorder) GetEntryAnAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEntryAnAccount", reflect.TypeOf((*MockStore)(nil).GetEntryAnAccount), arg0, arg1)
}
...
// GetTransferToFromAccount mocks base method.
func (m *MockStore) GetTransferToFromAccount(arg0 context.Context, arg1 db.GetTransferToFromAccountParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransferToFromAccount", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransferToFromAccount indicates an expected call of GetTransferToFromAccount.
func (mr *MockStoreMockRecorder) GetTransferToFromAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransferToFromAccount", reflect.TypeOf((*MockStore)(nil).GetTransferToFromAccount), arg0, arg1)
}
