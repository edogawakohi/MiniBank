...
const getTransferToFromAccount = `-- name: GetTransferToFromAccount :many
SELECT id, from_account_id, to_account_id, amount, created_at FROM transfers
...
func (q *Queries) GetTransferToFromAccount(ctx context.Context, arg GetTransferToFromAccountParams) ([]Transfer, error) {
	rows, err := q.db.Query(ctx, getTransferToFromAccount,
		arg.FromAccountID,
		arg.ToAccountID,
		arg.Limit,
		arg.Offset,
